...
export default function Sidebar() {
  ...
  return (
    <aside className="w-60 bg-sidebarBg border-r border-cardBorder flex flex-col h-screen select-none shrink-0">
      
      {/* Brand Header */}
      <div className="h-16 flex items-center px-6 border-b border-cardBorder gap-2.5">
