    ...
    <header className="h-16 border-b border-[#1e2240] bg-[#0d0f1a] flex items-center justify-between gap-3 px-4 md:px-8 select-none">
      ...
      <div className="relative flex-1 max-w-96 min-w-0">
        ...
        <input
          ...
          className="w-full bg-[#141628] border border-[#1e2240] rounded-lg py-1.5 pl-10 pr-4 sm:pr-12 text-xs text-textMain placeholder-muted focus:outline-none focus:border-primary transition-all duration-200"
          disabled
        />
