...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#07090e] text-slate-100 flex flex-col md:flex-row font-sans select-none overflow-y-auto">
      {/* Information Panel */}
      <div className="md:w-1/2 bg-[#0a0c12] border-r border-[#1e2240]/40 flex flex-col justify-between p-8 md:p-16 relative overflow-hidden">
